...
if(global.artifactSkull = 1 && global.artifactView = true)
{
	...
	image_speed = .15	;
	draw_sprite(textBg_spr,0,x,y+210);
	draw_text(x+100,y-100,string(global.totalArtifacts)+"/4");
