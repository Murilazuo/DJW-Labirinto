...
if(place_snapped(32,32) && keyboard_check(vk_left) != true && keyboard_check(vk_right) != true && keyboard_check(vk_up) != true && keyboard_check(vk_down) != true)
{
	...
	audio_stop_sound(caminhando_sound);
}
