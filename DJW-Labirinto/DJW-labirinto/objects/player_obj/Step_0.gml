...
else  // player in movement
{
	...
	if(audio_is_playing(snd_stepu))
	{
		
	}
	else
	{
		audio_sound_pitch(snd_stepu,random_range(.85,1.3));
		audio_play_sound(snd_stepu, 0,0);	
	}
}